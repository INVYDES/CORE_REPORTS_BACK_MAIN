-- ===================================================================
-- RESPALDO COMPLETO CoreReports - 2026-09-08
-- Generado: 2026-09-08 17:29:26
-- Base: BD/Tablas.sql + BD/04_Encuestas_y_Facturacion.sql + migraciones
-- Incluye: personal_access_tokens (Sanctum), migrations y seed inicial
-- Restaurar: mysql -u root -p < respaldo_completo_2026-09-08.sql
--   o: docker compose exec db mysql -u root -p747375 corereports < respaldo_completo_2026-09-08.sql
--   o: mysql -h 127.0.0.1 -P 3307 -u root -p747375 corereports < respaldo_completo_2026-09-08.sql
-- ===================================================================
SET FOREIGN_KEY_CHECKS=0;
SET NAMES utf8mb4;
CREATE DATABASE IF NOT EXISTS `corereports` CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `corereports`;
...
-- ===================================================================
-- COMPLEMENTO: tablas excluidas de Tablas.sql (se crean via artisan migrate)
-- ===================================================================
...
(1, '2026_09_03_000000_create_core_reports_schema', 1),
(2, '2026_09_04_182926_create_encuestas_and_facturacion_columns', 1),
(3, '2026_09_04_183411_add_notificacion_inapp_columns', 1),
(4, '2026_09_05_000035_create_personal_access_tokens_table', 1);

-- Tabla Sanctum para tokens API (HasApiTokens en App\Models\Usuario)
...
-- ===================================================================
-- 04_Encuestas_y_Facturacion.sql (idempotente, ya incluido en Tablas.sql pero se reaplica por seguridad)
-- ===================================================================
...
-- ===================================================================
-- SEED INICIAL (DatabaseSeeder -> CoreReportsSeeder)
-- password para todos: 'password' (hash bcrypt)
-- ===================================================================
INSERT IGNORE INTO `roles` (`id`, `nombre`, `codigo`, `descripcion`, `es_base`) VALUES
(0, 'Cliente', 'cliente', 'Solo crea tickets y ve los suyos', 1),
(1, 'Administrador Técnico', 'admin_tecnico', 'Supervisa operaciones y aprueba reportes', 1),
(2, 'Administrador Comercial', 'admin_comercial', 'Gestiona licencias y KPIs', 1),
(3, 'Técnico', 'tecnico', 'Ejecuta trabajos y genera reportes', 1);

INSERT IGNORE INTO `dependencias` (`id`, `nombre`, `rfc`, `tipo_licencia`, `fecha_expiracion`, `limite_usuarios`, `limite_reportes_mensuales`, `correo_contacto`, `correo_reportes`, `telefono`, `datos_facturacion`, `activa`) VALUES
(1, 'Automotriz del Bajío S.A. de C.V.', 'ABA-100520-H52', 'trial', '2028-05-20', 10, 100, 'contacto@autobajio.com', 'sistemas@autobajio.com', '442-123-4567', 'Parque Industrial', 1);

INSERT IGNORE INTO `areas` (`id`, `dependencia_id`, `codigo`, `nombre`, `activa`) VALUES
(1, 1, 'FUND', 'Área de Fundición', 1),
(2, 1, 'ENS-A', 'Línea de Ensamblaje A', 1),
(3, 1, 'ALM', 'Almacén General', 1);

-- Usuarios seed: password = $2y$12$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi (password)
INSERT IGNORE INTO `usuarios` (`id`, `dependencia_id`, `numero_empleado`, `rol`, `nombre`, `apellidos`, `email`, `password`, `estado`) VALUES
(1, 1, 'EMP001', 1, 'Admin', 'Tecnico', 'admin.tec@core.com', '$2y$12$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 1),
(2, 1, 'EMP002', 2, 'Admin', 'Comercial', 'admin.com@core.com', '$2y$12$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 1),
(3, 1, 'EMP003', 3, 'Juan', 'Tecnico', 'tecnico@core.com', '$2y$12$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 1),
(4, 1, 'EMP004', 0, 'Cliente', 'Demo', 'cliente@core.com', '$2y$12$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 1);
