...
class Reporte extends Model
{
    ...
    public function creador(): BelongsTo { return $this->belongsTo(Usuario::class, 'creado_por'); }
    public function responsable(): BelongsTo { return $this->belongsTo(Usuario::class, 'responsable_id'); }
    ...
    public function origen(): BelongsTo { return $this->belongsTo(self::class, 'reporte_origen_id'); }
    public function ejecutores(): HasMany { return $this->hasMany(ReporteEjecutor::class, 'reporte_id'); }
    public function materiales(): HasMany { return $this->hasMany(ReporteMaterial::class, 'reporte_id'); }
    public function evidencias(): HasMany { return $this->hasMany(ReporteEvidencia::class, 'reporte_id'); }

    public function scopePorTipo($q,$tipo){ return $tipo ? $q->where('tipo',$tipo) : $q; }
}
